...
public class ExcelReader {
	...
	public ExcelReader(InputStream inp) throws InvalidFormatException, IOException {
		wb = WorkbookFactory.create(inp);
	}
				...
				for (int i = 0; i < columnNum; i++) {
					...
					case Cell.CELL_TYPE_NUMERIC:
						if (DateUtil.isCellDateFormatted(cell)) {
							singleRow[n] = com.kingbo401.commons.util.DateUtil.formatDatetime(cell.getDateCellValue());
						} else {
